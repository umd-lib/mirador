...
describe('Pin', function() {
  ...
  describe('Pin Mouse Tool', function() {
    ...
    it('should change style when hovering pin',function(){
      var red = { r:1, g:0, b:0 };
      var blue = { r:0, g:0, b:1 };
      var alpha = 0.1;
      this.pin.onHover(true,this.shape,'red','blue',alpha);
    ...
    it('should change style back to original when not hovering pin',function(){

      var oldColor = this.shape.strokeColor;
      var oldFillColor = this.shape.fillColor;
      this.pin.onHover(true,this.shape,'red','blue',0.1);
